...
@router.post("/set-ttl")
async def set_custom_ttl(resource_id: str, ttl_hours: int, current_user: User = Depends(get_current_admin_user)):
    try:
        ...
        return {"message": f"TTL updated to {ttl_hours} hours"}
